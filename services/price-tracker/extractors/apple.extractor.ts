...
export const extractApple = async (
  ...
  try {
    ...
    // Apple India's JSON-LD offers array includes an EMI entry with a lower
    // price. We take the highest price offer to get the actual selling price.
    ...
    // Strategy 2: DOM selectors — race all in parallel, wait for title anchor first.
